...
DEFAULTS: dict[str, str] = {
    ...
    # Универсальный APK тяжелее сборки под одну архитектуру, зато ставится
    # на любой телефон: «приложение не установлено» на старом устройстве
    # обойдётся дороже лишних мегабайт трафика.
    "apk_url": f"{RELEASES}/TargetVPN-android-universal.apk",
    "apk_version": "",
    "ios_url": "",
    "ios_version": "",
